...
const Formulario = () => {
  ...
  const registroUsuarioMutation = async formData => {
    try {
  ...
  const manejoBoton = async (values, onsubmitProps) => {
    await registro(values, onsubmitProps)
  }

  // Funcion para manejar el registro de un Usuario
  const registro = async (values, onsubmitProps) => {
    ...
    registroUsuarioMutation(formData)
